...
window.addEventListener('load', function(event) {
    ...
    document.getElementsByClassName('go-to-bios')[0].addEventListener('click', () => {
    ...
    document.getElementsByClassName('go-to-more')[0].addEventListener('click', () => {
        document.getElementsByClassName('main-content')[0].classList.add('invisible')
        setTimeout(() => {
            document.getElementsByClassName('main-content')[0].classList.add('hidden')
        ...
        smoothMove(diorama.limits.x[1], 0, 134, 20, x => {
            diorama.position.x = x
            diorama.draw()
        })
    })
