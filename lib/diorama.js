...
Diorama.prototype.draw = function () {
    ...
    this.cutouts.map(cutout => {
        if (this.tiltable) {
            ...
            let adjustedTilt = {
                x: this.tilt.x * 2 //this.tiltMagnitude * (this.tilt.x / Math.abs(this.tiltLimits.x[0] - this.tiltLimits.x[1])),
                y: this.tilt.y * 2 //this.tiltMagnitude * (this.tilt.y / Math.abs(this.tiltLimits.y[0] - this.tiltLimits.y[1])),
            }
